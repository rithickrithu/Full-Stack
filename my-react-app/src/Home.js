...
export default function Home() {
    ...
    const loadEmployees = async () => {
        try {
            const result = await axios.get("http://ec2-54-253-49-79.ap-southeast-2.compute.amazonaws.com/api/get-all");
    ...
    const deleteEmployee = async (id) => {
        await axios.delete(`http://ec2-54-253-49-79.ap-southeast-2.compute.amazonaws.com/api/delete/${id}`);
        loadEmployees();
    };
